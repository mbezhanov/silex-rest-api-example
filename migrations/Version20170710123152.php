 ...
 */
class Version20170710123152 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__diary AS SELECT id, meal_id, food_id, date FROM diary');
        ...
        $this->addSql('INSERT INTO diary (id, meal_id, food_id, date) SELECT id, meal_id, food_id, date FROM __temp__diary');
